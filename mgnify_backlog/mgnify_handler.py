...
class MgnifyHandler:
    ...
    def get_annotation_jobs(self, run_or_assembly_accessions=None, study_accessions=None, status_descriptions=list(),
                            priority=None,
        ...
        if status_descriptions:
            if isinstance(status_descriptions, str):
                status_descriptions = list([status_descriptions])
